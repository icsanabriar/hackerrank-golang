...
func TestDiwaliLightsFirstGivenCase(t *testing.T) {
	...
	if result != expected {
		t.Errorf("Diwali ligths first case was incorrect, got: %d, want: %d.", result, expected)
	}
}
...
func TestDiwaliLightsSecondGivenCase(t *testing.T) {
	...
	if result != expected {
		t.Errorf("Diwali ligths second case was incorrect, got: %d, want: %d.", result, expected)
	}
}
