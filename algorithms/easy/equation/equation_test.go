...
func TestEquationFirstGivenCase(t *testing.T) {
	...
	if !reflect.DeepEqual(result, expected) {
		t.Errorf("Sequence equation first case was incorrect, got: %v, want: %v.", result, expected)
	}
}
...
func TestEquationSecondGivenCase(t *testing.T) {
	...
	if !reflect.DeepEqual(result, expected) {
		t.Errorf("Sequence equation second case was incorrect, got: %v, want: %v.", result, expected)
	}
}
