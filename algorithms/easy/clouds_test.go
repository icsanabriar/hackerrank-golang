...
func TestJumpingFirstGivenCase(t *testing.T) {
	...
	if result != expected {
		t.Errorf("Jumping on clouds first case was incorrect, got: %d, want: %d.", result, expected)
	}
}
...
func TestJumpingSecondGivenCase(t *testing.T) {
	...
	if result != expected {
		t.Errorf("Jumping on clouds second case was incorrect, got: %d, want: %d.", result, expected)
	}
}
