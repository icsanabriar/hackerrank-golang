...
func timeInWords(h int64, m int64) string {
	// Get number static map.
...
// getNumberString returns a map with the number string representation.
func getNumberString() map[int64]string {
